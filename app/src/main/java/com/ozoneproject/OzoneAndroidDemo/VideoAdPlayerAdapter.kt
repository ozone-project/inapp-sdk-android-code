...
class VideoAdPlayerAdapter : VideoAdPlayer {

    private var LOGTAG = "IMABasicSample"
    private var POLLING_TIME_MS: Long = 250
    private var INITIAL_DELAY_MS: Long = 250
    private var videoPlayer: VideoView? = null
    private var audioManager: AudioManager? = null
    private var videoAdPlayerCallbacks: kotlin.collections.ArrayList<VideoAdPlayerCallback> = ArrayList()
    ...
    constructor(videoPlayer: VideoView?, audioManager: AudioManager?) {
        this.videoPlayer = videoPlayer
        this.videoPlayer!!.setOnCompletionListener { mediaPlayer: MediaPlayer? -> notifyImaOnContentCompleted() }
    ...
    override fun playAd(adMediaInfo: AdMediaInfo) {
        ...
        videoPlayer!!.setOnErrorListener(
            MediaPlayer.OnErrorListener { mediaPlayer: MediaPlayer?, errorType: Int, extra: Int ->
